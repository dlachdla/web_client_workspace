...
const saveGuestbook = () => {
    ...
    // localStorage에 저장
    // guestbooks로 저장된 배열이 있다면 그걸 사용, 없으면 새 배열 생성 ||(or)
 ...
 const renderGuestbooks = () => {
    ...
    //         <td>${name}</td>
    //         <td>${content}</td>
    //         <td>${converToDatTime(createdAt)}</td>
    //     </tr>`;
    //     tbody.innerHTML += tr;
    // });
